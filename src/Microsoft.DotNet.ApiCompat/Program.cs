...
namespace Microsoft.DotNet.ApiCompat
{
    public class Program
    {
        public static int Main(string[] args)
        {
            ...
            app.OnExecute(() => Executor.Run(HostEnvironment.SplitPaths(contracts.Value),
                HostEnvironment.SplitPaths(implDirs.Value()),
                Executor.GetOutput(outFilePath.Value()),
                rightOperand.Value(),
                leftOperand.Value(),
                listRules.HasValue(),
                HostEnvironment.SplitPaths(baseline.Value()),
                validateBaseline.HasValue(),
                resolveFx.HasValue(),
                skipUnifyToLibPath.HasValue(),
                HostEnvironment.SplitPaths(contractDepends.Value()),
                ...
                HostEnvironment.SplitPaths(excludeAttributes.Value()),
